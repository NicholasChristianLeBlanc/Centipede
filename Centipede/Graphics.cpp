...
namespace SDLFramework {
	...
	bool Graphics::Init() {
		...
		mWindow = SDL_CreateWindow(WINDOW_TITLE,    // window title        
			SDL_WINDOWPOS_UNDEFINED,				// window x pos        
			SDL_WINDOWPOS_UNDEFINED,				// window y pos        
			SCREEN_WIDTH * windowScale,				// window width        
			SCREEN_HEIGHT * windowScale,            // window height        
	...
	SDL_Texture* Graphics::CreateTextTexture(TTF_Font* font, std::string text, SDL_Color color) { 
		...
		if (tex == nullptr) { std::cerr << "CreateTextTexture:: SDL_CreateTextureFromSurface Error: " << SDL_GetError() << std::endl;        
			return nullptr; 
		}    
